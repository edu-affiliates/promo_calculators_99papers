...
class TPSearch extends React.Component {
    ...
    render() {
        return (
            <div className="tp-search-wrap">
                <input className="tp-search" value={this.state.searchString}
...
export default connect(mapStateToProps, mapDispatchToProps)(TPSearch);
